...
class Profile(models.Model):
    ...
    name = models.CharField(_('Ім’я'), max_length=200, blank=True)
    ...
    skype = models.CharField(_('Логін Skype'), null=True, max_length=200)
    icq = models.CharField(_('ICQ'), null=True, max_length=200,)
    website = models.URLField(_('Адреса сторінки в соціальній мережі'), null=True, blank=True, verify_exists=False)
    education = models.CharField(_('Освіта (ВНЗ, факультет)'), max_length=500)
    work = models.CharField(_('Місце роботи'), max_length=600)
    experience = models.CharField(_('Досвід гри у дебати'), max_length=600)
    club = models.OneToOneField(Club, null=True, verbose_name=_('club'))
    social_work_exp = models.CharField(_('Досвід громадської роботи'), max_length=600)
